...
namespace CsharpTest
{
   [TestFixture("chrome", "88.0", "windows 10")]
        ...
        public class TestClass
        {
            ...
            public void init()
            {
                String username = "gayathrilomada245";
                String accesskey = "Hc1XDWqJN2vpA5vGofxH4JlP4O53xWs9RlQ8hlsLs8QOATYik0";
                ...
                capabilities.SetCapability("build", "CSharpSelenium");

                driver = new RemoteWebDriver(new Uri("https://gayathrilomada245:Hc1XDWqJN2vpA5vGofxH4JlP4O53xWs9RlQ8hlsLs8QOATYik0@hub.lambdatest.com/wd/hub"), capabilities, TimeSpan.FromSeconds(600));
            ...
            public void input_Demo()
            {
                ...
                driver.FindElement(By.Id("inputEmail4")).SendKeys("gayathri@gmail.com");
